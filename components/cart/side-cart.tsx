...
// Payment method icons component - side cart version
const PaymentIcons = () => (
  <div className="flex flex-col gap-2">
    {/* Desktop version with text */}
    <div className="hidden md:flex items-center gap-1 justify-center py-3 px-0 bg-gray-900 rounded-md">
      <div className="flex gap-2 items-center justify-center flex-wrap">
        {/* Visa */}
        <div className="bg-white px-2 py-0.5 rounded border border-gray-700 shadow-sm">
          <span className="text-[#1434CB] font-bold text-sm tracking-wider">VISA</span>
        </div>
        {/* Mastercard */}
        <div className="bg-white px-1 py-1 rounded border border-gray-700 shadow-sm">
        ...
        {/* Apple Pay */}
        <div className="bg-black px-2 py-1.5 rounded shadow-sm flex items-center gap-0.5">
        ...
        {/* Google Pay */}
        <div className="bg-white px-2 py-1.5 rounded border border-gray-700 shadow-sm flex items-center gap-1">
          ...
          <span className="text-gray-200 font-semibold text-xs">Pay</span>
        </div>
        {/* PayPal */}
        <div className="bg-gradient-to-r from-[#003087] to-[#012169] text-white px-2 py-1.5 rounded text-xs font-bold flex items-center shadow-sm">
          Pay<span className="text-[#009CDE]">Pal</span>
        </div>
        {/* Klarna */}
        <div className="bg-gradient-to-r from-pink-500 to-pink-600 text-white px-2 py-1.5 rounded text-xs font-bold shadow-sm">
          Klarna
        </div>
      </div>
    </div>
    ...
    <div className="flex md:hidden items-center justify-center gap-2 py-3">
      ...
      {/* Mastercard */}
      <div className="bg-white px-1.5 py-1 rounded border border-gray-700 shadow-sm">
      ...
      {/* Apple Pay */}
      <div className="bg-black px-2 py-1 rounded shadow-sm flex items-center gap-0.5">
        <svg className="h-3 w-3" viewBox="0 0 24 24" fill="white">
          <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
        </svg>
        <span className="text-white font-semibold text-[10px]">Pay</span>
      </div>
      {/* Google Pay */}
      <div className="bg-white px-2 py-1 rounded border border-gray-700 shadow-sm flex items-center gap-0.5">
        ...
        <span className="text-gray-700 font-semibold text-[10px]">Pay</span>
      </div>
      {/* PayPal */}
                  ...
                  <div className="flex h-full flex-col bg-black text-white">
                    ...
                    {items.length > 0 && (
                      <div className="border-t border-gray-800 px-6 py-6">
                        ...
                        <div className="hidden md:flex items-center justify-center gap-2 text-xs text-gray-400 mb-4">
