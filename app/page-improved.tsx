...
export default async function Home() {
  ...
  return (
    <HomeContent blackboardProducts={blackboardProducts} blackboardWithVariations={blackboardWithVariations} getDisplayName={getDisplayName} getPriceRange={getPriceRange} />
  )
}

function HomeContent({ blackboardProducts, blackboardWithVariations, getDisplayName, getPriceRange }: any) {
  const [selectedInstructor, setSelectedInstructor] = useState<any>(null)
  const [foundationDesign, setFoundationDesign] = useState<'A' | 'B'>('A')
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Problem/Solution Section - Toggle between designs */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          {/* Design Toggle for Preview */}
          <div className="text-center mb-8">
            <div className="inline-flex gap-2 bg-gray-100 p-1 rounded-full">
              <button
                onClick={() => setFoundationDesign('A')}
                className={`px-6 py-2 rounded-full font-semibold transition-all ${
                  foundationDesign === 'A' ? 'bg-[#ffed00] text-black' : 'text-gray-600'
                }`}
              >
                Design A
              </button>
              <button
                onClick={() => setFoundationDesign('B')}
                className={`px-6 py-2 rounded-full font-semibold transition-all ${
                  foundationDesign === 'B' ? 'bg-[#ffed00] text-black' : 'text-gray-600'
                }`}
              >
                Design B
              </button>
          ...
          {foundationDesign === 'A' ? (
            /* DESIGN A: Visual Impact with Icons and Stats */
            <>
              ...
              {/* Visual Kinetic Chain Diagram */}
              <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-r from-gray-900 to-black rounded-2xl p-8 text-white">
                  <h3 className="text-2xl font-bold mb-6 text-center">The Kinetic Chain Effect</h3>
                  <div className="flex items-center justify-between">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-[#ffed00] rounded-full flex items-center justify-center mx-auto mb-2">
                        <span className="text-black font-bold">FEET</span>
                      </div>
                      <p className="text-xs">Foundation</p>
                    </div>
                    <ChevronRight className="h-6 w-6 text-[#ffed00]" />
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-2">
                        <span className="text-white font-bold">KNEES</span>
                      </div>
                      <p className="text-xs">Stability</p>
                    </div>
                    <ChevronRight className="h-6 w-6 text-gray-500" />
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-2">
                        <span className="text-white font-bold">HIPS</span>
                      </div>
                  ...
                  <p className="text-center mt-6 text-gray-300">
                    When your feet are weak, the entire chain compensates, leading to pain and dysfunction
                  </p>
                </div>
              </div>
            </>
          ) : (
            /* DESIGN B: Interactive Before/After Style */
            <>
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Transform your body from the ground up with scientifically proven foot training
                  </p>
                </div>
